...
import ABSBasicHeader from '../components/ABSBasicHeader';
...
@extendsRootLayout()
class BasicHeaderContentLayout extends React.Component<any, any> {
  render() {
    ...
    return (
      <Layout>
        ...
        <Layout style={{ height: '100vh'}} >
          <Content className={'abs-basic-layout'} style={{ height: '100%' }}>
            <PerfectScrollbar>
              {
                // 自动生成路由
...
export default connect(mapStateToProps)(BasicHeaderContentLayout); 
