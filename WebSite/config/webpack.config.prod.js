...
const cssFilename = `static/css/[name].${process.env.VERSION}.css`;
...
module.exports = {
  ...
  plugins: [
    ...
    new SWPrecacheWebpackPlugin({
      ...
      // Updated by cgzhou because some "GET" request will always be cached in firfox during downloading file
      handleFetch: false,
