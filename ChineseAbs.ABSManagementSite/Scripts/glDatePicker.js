 ...
 */
 ;(function() {
	...
	$.fn.glDatePicker.defaults =
	{
	    ...
	    // Year offsets of selectable years from present back and forward if *selectableYears* not set
	    // The default values indicate 5 years backward and 10 years forward
		selectableYearOffset: [5, 10],

	    // List of selectable years.  If not provided, will default to *selectableYearsOffset*-years
		// back and forward.
	...
	var glDatePicker = (function() {
		...
		glDatePicker.prototype =
		{
			...
			render: function(renderCalback) {
				...
				var selectableYears = getSelectableList(todayVal.year - options.selectableYearOffset[0], todayVal.year + options.selectableYearOffset[1], options.selectableYears);
