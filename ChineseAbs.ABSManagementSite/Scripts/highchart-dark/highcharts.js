...
zb = A.grep, Pb = A.offset, Ua = A.map, K = A.addEvent, X = A.removeEvent, G = A.fireEvent, Qb = A.washMouseEvent, kb = A.animate, db = A.stop; S = {
    colors: "#7cb5ec,#434348,#90ed7d,#f7a35c,#8085e9,#f15c80,#e4d354,#2b908f,#f45b5b,#91e8e1".split(","), symbols: ["circle", "diamond", "square", "triangle", "triangle-down"], lang: {
        ...
        line: {
            allowPointSelect: !1, showCheckbox: !1, animation: { duration: 1E3 }, events: {}, lineWidth: 2, marker: { lineWidth: 0, radius: 4, lineColor: "#FFFFFF", states: { hover: { enabled: !0, lineWidthPlus: 1, radiusPlus: 2 }, select: { fillColor: "#FFFFFF", lineColor: "#000000", lineWidth: 2 } } }, point: { events: {} }, dataLabels: {
                align: "center",
                formatter: function () { return this.y === null ? "" : z.numberFormat(this.y, -1) }, style: { color: "contrast", fontSize: "11px", fontWeight: "normal", textShadow: "" }, verticalAlign: "bottom", x: 0, y: 0, padding: 5
    ...
    }, credits: { enabled: !0, text: "CNABS", href: "http://www.cn-abs.com", position: { align: "right", x: -10, verticalAlign: "bottom", y: -5 }, style: { cursor: "pointer", color: "#909090", fontSize: "9px" } },
    magnifier: { enabled: 0, text: "放大", href: '', position: { align: "right", x: -45, verticalAlign: "bottom", y: -5 }, style: { cursor: "pointer", color: "#B7AFA5", fontSize: "12px" } },
    toExcel: { enabled: 0, text: "下载", href: '', position: { align: "right", x: -80, verticalAlign: "bottom", y: -5 }, style: { cursor: "pointer", color: "#B7AFA5", fontSize: "12px" } },
...
g) && a.setTickInterval(!0)
    }), this.getMargins(); this.drawChartBox(); this.hasCartesianSeries && n(a, function (a) { a.render() }); if (!this.seriesGroup) this.seriesGroup = b.g("series-group").attr({ zIndex: 3 }).add(); this.renderSeries(); this.renderLabels(); this.showCredits(c.credits); this.showMagnifier(c.magnifier); this.showToExcel(c.toExcel); this.hasRendered = !0
...
showMagnifier: function (a) { if (a.enabled && !this.magnifier) this.magnifier = this.renderer.text(a.text, 0, 0).on("click", function () { if (a.href) location.href = a.href }).attr({ align: a.position.align, zIndex: 8 }).css(a.style).add().align(a.position) },
showToExcel: function (a) { if (a.enabled && !this.toExcel) this.toExcel = this.renderer.text(a.text, 0, 0).on("click", function () { if (a.href) location.href = a.href }).attr({ align: a.position.align, zIndex: 8 }).css(a.style).add().align(a.position) },
    destroy: function () {
