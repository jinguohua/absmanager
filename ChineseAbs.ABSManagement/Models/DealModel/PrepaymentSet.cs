...
{
    public class PrepaymentSet: BaseDataContainer<TablePrepaymentSet>
    {
        public PrepaymentSet()
        {
        }

        public PrepaymentSet(TablePrepaymentSet prepaymentSet)
            : base(prepaymentSet)
        {
        }
        ...
        public override TablePrepaymentSet GetTableObject()
        {
            var obj = new TablePrepaymentSet();
            obj.prepayment_set_id = Id;
            obj.prepayment_set_guid = Guid;
        ...
        public override void FromTableObject(TablePrepaymentSet obj)
        {
            Id = obj.prepayment_set_id;
            Guid = obj.prepayment_set_guid;
